...
///   meeting title.
///
/// Only compiled when `ActivityKit` is available — Mac Catalyst and
/// macOS can import the header but `ActivityAttributes` is marked
/// unavailable, so the whole declaration is conditional.
